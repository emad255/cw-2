...
var projectlinks=document.getElementsByClassName("projects_link");
var projectscontents=document.getElementsByClassName("projects_content");

function opentab(tabname){
    for(projectlink of projectlinks){
        projectlink.classList.remove("active_link")
    }
    for(projectscontent of projectscontents){
        projectscontent.classList.remove("active_content")
    }
